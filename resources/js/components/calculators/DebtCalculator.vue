<template>
  <div>
    <p class="text-2xl">
      ...
      <span v-else class="text-red-700"> in 80+ years </span>
    </p>
    <p class="text-xl mt-6">
      Total interest:
      <formatter-currency v-if="interestPaid > -1" class="text-red-700" :amount="interestPaid" />
    ...
    <div class="sm:w-2/3 mt-10">
      <div class="form-row">
        ...
        <div class="form-row__input input-addon--start">
          ...
          <input v-model.number="currentBalance" class="input-text" type="number" step="0.1" @keyup="calculate" />
        </div>
      </div>
      <div class="form-row">
        <label class="form-row__label">
        ...
        <div class="form-row__input input-addon--end">
          <input v-model.number="interestRate" class="input-text" type="number" step="0.1" @keyup="calculate" />
          <span class="input-addon">%</span>
        </div>
      </div>
      <div class="form-row">
