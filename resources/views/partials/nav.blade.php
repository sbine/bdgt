    ...
    <toggle class="w-11/12 xl:w-3/4 mx-auto flex flex-wrap items-center justify-between">
        <template v-slot="{ isOn, toggle }">
            ...
            <div class="block lg:hidden">
                <button aria-label="Toggle menu" class="flex items-center border border-gray-400 hover:border-white rounded-sm text-gray-200 hover:text-white px-3 py-2" @click="toggle">
